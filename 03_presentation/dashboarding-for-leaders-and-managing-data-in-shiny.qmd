...
Now, we'll open `R_Workshop/tutorial_reactives/app_reactives.R` and work from there. 
...
Now, we'll open `R_Workshop/tutorial_modules/app_modules.R` and work from there. 
